        ...
        <div className="relative border-t border-gray-700/50 mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              ...
              <Link
                to="/contact"
                title="Have a question or facing an issue? Reach out to our team and we'll help you out."
              ...
              >
                ...
                <span
                  role="tooltip"
                  className="pointer-events-none absolute bottom-full left-1/2 z-20 mb-3 w-56 -translate-x-1/2 rounded-lg bg-gray-800 px-3 py-2 text-xs text-gray-200 text-center shadow-lg ring-1 ring-gray-700/60 opacity-0 translate-y-1 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0"
                >
                  Have a question or facing an issue? Reach out and we'll help you
                  out.
